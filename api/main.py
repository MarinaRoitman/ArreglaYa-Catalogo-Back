...
from routes import auth, prestadores, zonas, habilidades, rubros, pedidos, notificaciones,calificaciones, usuarios
...
# ===========================
app = FastAPI(
    title="API Desarrollo 2 Development Environment",
